"""Alembic env.py for framework-bundled migrations (I16).
...
Uses a separate ``fas_alembic_version`` table so framework migrations don't
collide with the user project's ``alembic_version`` table.
"""
